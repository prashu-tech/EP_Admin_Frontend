...
const ImageComponent_mobile= () => {
  return (
    <div className="flex flex-row md:flex-row justify-end items-center md:gap-2 gap-8 bg-white p-4 rounded-xl shadow-md mt-4 md:mt-6 mb-4 md:mb-8 mx-2 md:mx-12 w-24 ml-40">
      {/* Timer Section */}
