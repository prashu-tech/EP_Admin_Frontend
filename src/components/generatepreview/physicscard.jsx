...
const PhysicsCard = () => {
  return (
    <div className="p-4 bg-blue-300 shadow-xl max-w-3xl mx-8 rounded-tr-2xl rounded-tl-2xl  w-[34rem] overflow-x-hidden max-h-[500px] mt-8">
      {/* Header Section */}
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          <h2 className="text-3xl font-semibold">Physics</h2>
