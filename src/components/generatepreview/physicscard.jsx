...
const PhysicsCard = () => {
  return (
    <div className="p-4 bg-[#B1CEFB] shadow-xl  rounded-tr-2xl rounded-tl-2xl ml-6 mr-3 w-[34rem] max-h-[700px] -mt-60">
      {/* Header Section */}
      ...
      <div className="bg-white rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] ">
        ...
        <table className="w-full table-auto border-collapse:separate border-spacing-y-2 ">
          <thead className='border-1b '>
            <tr className="border-b  bg-[#F5F5F5] border-gray-300 border-collapse:separate ">
