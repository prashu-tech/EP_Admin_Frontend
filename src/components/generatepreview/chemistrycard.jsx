...
const ChemistryCard = () => {
  return (
    <div className="p-4 bg-[#B1CEFB] shadow-xl max-w-3xl mx-8 rounded-tr-2xl rounded-tl-2xl w-[34rem] overflow-x-hidden max-h-[500px] -mt-60 ">
      {/* Header Section */}
      <div className="flex items-center space-x-4 mb-6">
        <div className="relative bg-[#B1CEFB] shadow-lg">
          <img
            src="/Atoms-1.svg"  // Ensure the icon path is correct
            alt="Chemistry Icon"
      ...
      <div className="bg-white rounded-2xl shadow-md p-4">
        ...
        <table className="min-w-full table-auto border-collapse">
          <thead>
            <tr className="border-b  bg-gray-200 border-gray-300">
