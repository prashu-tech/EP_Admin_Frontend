...
// Comprehensive chart data for all three time-of-day batches (Morning, Afternoon, Evening)
// and all three sub-batches (B21, B22, B23).
const chartDataMap = {
  Morning: {
    B21: [
  ...
  Afternoon: {
    B21: [
      { day: "Mon", Active: 4, Inactive: 2, Away: 2 },
      { day: "Tue", Active: 5, Inactive: 2, Away: 2 },
      { day: "Wed", Active: 3, Inactive: 3, Away: 2 },
      { day: "Thu", Active: 4, Inactive: 2, Away: 3 },
      { day: "Fri", Active: 5, Inactive: 1, Away: 3 },
      { day: "Sat", Active: 2, Inactive: 3, Away: 3 },
      { day: "Sun", Active: 3, Inactive: 2, Away: 4 },
    ],
    B22: [
      { day: "Mon", Active: 2, Inactive: 1, Away: 4 },
      { day: "Tue", Active: 3, Inactive: 3, Away: 2 },
      { day: "Wed", Active: 4, Inactive: 1, Away: 3 },
      { day: "Thu", Active: 6, Inactive: 2, Away: 1 },
      { day: "Fri", Active: 5, Inactive: 2, Away: 2 },
      { day: "Sat", Active: 4, Inactive: 3, Away: 2 },
      { day: "Sun", Active: 6, Inactive: 2, Away: 2 },
    ],
    B23: [
      { day: "Mon", Active: 6, Inactive: 1, Away: 2 },
      { day: "Tue", Active: 4, Inactive: 2, Away: 3 },
      { day: "Wed", Active: 5, Inactive: 3, Away: 2 },
      { day: "Thu", Active: 3, Inactive: 4, Away: 2 },
      { day: "Fri", Active: 4, Inactive: 2, Away: 3 },
      { day: "Sat", Active: 6, Inactive: 3, Away: 1 },
      { day: "Sun", Active: 2, Inactive: 3, Away: 4 },
    ],
  },

  Evening: {
    B21: [
      { day: "Mon", Active: 2, Inactive: 2, Away: 4 },
      { day: "Tue", Active: 4, Inactive: 3, Away: 1 },
      { day: "Wed", Active: 3, Inactive: 2, Away: 3 },
      { day: "Thu", Active: 5, Inactive: 1, Away: 3 },
      { day: "Fri", Active: 2, Inactive: 3, Away: 4 },
      { day: "Sat", Active: 4, Inactive: 2, Away: 3 },
      { day: "Sun", Active: 5, Inactive: 2, Away: 3 },
    ],
    B22: [
      { day: "Mon", Active: 3, Inactive: 3, Away: 2 },
      { day: "Tue", Active: 6, Inactive: 1, Away: 2 },
      { day: "Wed", Active: 5, Inactive: 2, Away: 3 },
      { day: "Thu", Active: 5, Inactive: 3, Away: 2 },
      { day: "Fri", Active: 3, Inactive: 1, Away: 4 },
      { day: "Sat", Active: 2, Inactive: 3, Away: 4 },
      { day: "Sun", Active: 6, Inactive: 2, Away: 2 },
    ],
    B23: [
      { day: "Mon", Active: 5, Inactive: 2, Away: 3 },
      { day: "Tue", Active: 6, Inactive: 2, Away: 2 },
      { day: "Wed", Active: 5, Inactive: 3, Away: 2 },
      { day: "Thu", Active: 7, Inactive: 1, Away: 2 },
      { day: "Fri", Active: 5, Inactive: 2, Away: 3 },
      { day: "Sat", Active: 3, Inactive: 4, Away: 2 },
      { day: "Sun", Active: 4, Inactive: 2, Away: 3 },
    ],
  },
};

const LoginAttendance = ({ batch }) => {
  // batch is passed from Calendar
  ...
  // If "batch" is empty or undefined, default to "Morning"
  const currentBatch = batch || "Morning";

  // Combine time-of-day batch & sub-batch to grab the correct data
  const currentData = chartDataMap[currentBatch]?.[subBatch] || [];
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 w-[38rem] ">
      ...
      {currentData.length === 0 && (
        <div className="text-red-500 font-semibold mb-2">
          No chart data found for "{currentBatch}" batch and "{subBatch}" sub-batch.
        </div>
      )}
