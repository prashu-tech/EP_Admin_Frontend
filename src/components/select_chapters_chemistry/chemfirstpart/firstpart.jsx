      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <div className="bg-blue-50 text-blue-700 cursor-pointer px-4 py-2 rounded-lg border border-blue-100 font-medium flex items-center gap-2" onClick={()=> handleSubjectClick("physics")}>
              <span className="bg-blue-600 w-3 h-3 rounded-full"></span>
              Physics
            </div>
            <div className="bg-purple-50 text-purple-700 cursor-pointer px-4 py-2 rounded-lg border-2 border-purple-600 font-medium flex items-center gap-2" onClick={()=>handleSubjectClick("chemistry")}>
              <span className="bg-purple-600 w-3 h-3 rounded-full"></span>
              Chemistry 
            </div>
            <div className="bg-green-50 text-green-700 px-4 py-2 rounded-lg font-medium flex items-center gap-2" onClick={()=> handleSubjectClick("biology")}>
