    ...
    <section className="block md:hidden p-4 gap-2 font-['Segoe_UI']">
      ...
      <div className="flex flex-col items-center gap-4 mb-6 w-full px-4">
        <div className="relative w-full max-w-xl bg-[#F5F7FA] py-2 rounded-full">
          ...
          />
          <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600 text-lg ml-2">
            <BsSearch />
          </span>
        </div>
      </div>
      ...
      {/* Centered Heading */}
      <h1 className="text-xl text-center font-medium font-SegoeUI">Select Chemistry Chapters</h1>
