      ...
      <div className="flex flex-col items-center px-4 pt-6 pb-4">
        ...
        <div className="w-full my-4">
          <input
            ...
            className="w-full border rounded-lg p-3 text-sm border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-[0_2px_4px_rgba(0,0,0,0.1)]"
          />
        </div>

        {/* Action Buttons with Icons */}
        <div className="flex w-full justify-between gap-2 my-6">
          <button className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-3 text-xs rounded flex items-center justify-center gap-1 flex-1">
