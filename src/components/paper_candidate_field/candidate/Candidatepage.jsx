...
const CandidateTable = () => {
  ...
  return (
    <div className="hidden md:flex flex-col justify-center items-center p-4 mt-2 space-y-6 w-full">
      <div className="p-6 bg-white shadow-[1px_1px_5px_lightgray] rounded-lg w-[90%]">
        {/* Header Section */}
        <div className="flex justify-between items-center mb-4 w-full">
          <h2 className="text-xl font-Open Sans font-normal">Candidate Field</h2>
          <button
            onClick={addNewTable}
            className="flex items-center bg-[#007AFF] text-white font-Open Sans px-4 py-1 rounded-md transition text-base"
          >
        ...
        <div className="flex flex-col space-y-4 w-full">
          {tables.map((tableId) => (
            <div key={tableId} className="overflow-x-auto border border-gray-400 w-full">
              <table className="w-full text-lg font-Nunito Sans font-normal">
                <thead>
