  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          ref={sidebarRef}
          className="fixed top-0 left-0 h-screen bg-[#007AFF] text-white w-1/6 z-50 shadow-md"
        >
          {/* Logo Section */}
